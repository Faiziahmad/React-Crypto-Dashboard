    ...
    render() {
        return (
            <div>
                ...
                <section className="row m-3 mb-1" style={{ marginTop: ' 2px !important' }}>
                <div className="card text-white text-center  m-3" style={{ width: "11rem", backgroundColor: "rgb(25, 39, 62)", marginTop: "0px !important" }}>
                        <div className="card-body">
                            <h6 className="card-title" style={{ fontFamily: 'NHaasGroteskDSPro-65Md' }}>Market Cap 24Hrs</h6>
                            <p className="card-text fw-bold fs-5" style={{ color: "#72D141" }}>
                                {this.props.mCap24} %
                            </p>
                        </div>
                    </div>
                    ...
                    style={{ width: "11rem", backgroundColor: "rgb(25, 39, 62)", marginTop: "0px !important" }}>
                ...
                <div>
                    ...
                    <div style={{
                        ...
                        fontWeight: '700', color: "#50E3C2", textDecoration: 'none solid rgb(255, 255, 255)',
                        textAlign: 'center'
                    }}>
